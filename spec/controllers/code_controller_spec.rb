...
describe CodeController do
  ...
  # CodeController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all code as @code" do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested code" do
        code = Code.create! valid_attributes
        # Assuming there are no other code in the database, this
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the code list" do
      code = Code.create! valid_attributes
      delete :destroy, {:id => code.to_param}, valid_session
      response.should redirect_to(code_index_url)
    end
  end
