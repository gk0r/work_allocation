  ...
  def create
    ...
    respond_to do |format|
      if @software_release.save
        format.html { redirect_to software_release_url, notice: 'Software release was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @software_release.update_attributes(params[:software_release])
        format.html { redirect_to @software_release, notice: 'Software release was successfully updated.' }
